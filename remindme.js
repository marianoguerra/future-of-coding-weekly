...
function generateScriptForThisWeek(now, dayNumber) {
  ...
  console.log(
    `mkdir future-of-newsletters/mail-sent/${dateDir}/`,
  );
  console.log(
  ...
  console.log(
    `bat future-of-newsletters/mail-sent/${dateDir}/config.toml`,
  );
  ...
  console.log(
    `hx future-of-newsletters/mail-sent/${dateDir}/mail.html`,
  );
  console.log(
    `hx future-of-newsletters/mail-sent/${dateDir}/mail.txt`,
  );
  console.log(
  ...
  console.log(
    `cd future-of-newsletters/foc-server/;cargo run -- send-newsletter --mail-path ../mail-sent/${dateDir}/ --db-path ~/.foc/foc.db`,
  );
}
