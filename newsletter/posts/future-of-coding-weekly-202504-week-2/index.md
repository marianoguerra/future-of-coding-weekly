<!--
.. title: Future of Coding Weekly 2025/04 Week 2
.. slug: future-of-coding-weekly-202504-week-2
.. date: 2025-04-13 23:36:16 UTC+02:00
.. tags: 
.. category: 
.. link: 
.. description: 
...
🎥 This Game Did Everything. What Happened? 📝 Self-Steering Language Models Ω OhmJS: A JavaScript library for building parsers, interpreters, compilers, and more
...
[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/devlog-together.html#2025-04-07T07:12:02.081Z)

I've integrated my [recent](https://akkartik.name/post/luaML2) [💬 #share-your-work@2025-04-05](https://history.futureofcoding.org/?fromDate=2025-04-02&toDate=2025-04-08&channel=share-your-work&filter=#2025-04-05T06:28:02.122Z) into [my template repository for building apps based on the Lua Carousel UI](https://git.sr.ht/~akkartik/template-carousel2) which supports making changes to apps on the phone (or computer). Now any new app built from this starting point will have a rudimentary system of online help for the entire stack:
...
## 🚪 [Jumpgate: Bulk transfer notebooks between storage mediums.](https://observablehq.com/@tomlarkworthy/jumpgate) via [Tom Larkworthy](https://webcode.run)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/devlog-together.html#2025-04-12T13:05:41.415Z)
...
sourcecode on Observable: [observablehq.com/@tomlarkworthy/jumpgate](https://observablehq.com/@tomlarkworthy/jumpgate)

git PR opened by the notebook: [github.com/tomlarkworthy/lopecode/pull/4](https://github.com/tomlarkworthy/lopecode/pull/4)

as my repo is configured as a static host as well, we can see the result of jumpgate after going through the jumpgate here: [tomlarkworthy.github.io/lopecode/notebooks/@tomlarkworthy_jumpgate.html#view=S100%28%40tomlarkworthy%2Fmodule-selection%29](https://tomlarkworthy.github.io/lopecode/notebooks/@tomlarkworthy_jumpgate.html#view=S100%28%40tomlarkworthy%2Fmodule-selection%29)
...
## 🌝 [f-string.lua – ezhik.jp](https://ezhik.jp/f-string.lua/) via **Ezhik**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/devlog-together.html#2025-04-13T13:10:55.668Z)

Keep getting sidetracked by making little Lua libraries. This one implements Python-style f-strings in Lua. Pretty cool to have a language that lets you go this far with its syntax. With just a little bit of work this could be extended to implement [Python's template strings (PEP 750)](https://peps.python.org/pep-0750/) and then we could use Lua to make all sorts of DSLs. My initial motivation was easier printf debugging, though 😅.
...
## Ω [OhmJS: A JavaScript library for building parsers, interpreters, compilers, and more](http://ohmjs.org) via [Paul Tarvydas](https://guitarvydas.github.io/2021/09/23/Manifesto.html)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/devlog-together.html#2025-04-13T16:19:58.666Z)

If you enjoyed fooling with parsers, I would recommend looking into [OhmJS](http://ohmjs.org). OhmJS (plus Ohm-editor) saves a lot of work when building parsers. A game changer. There is the other half, too - once you've parsed something, what do you do with the information? I've found that doing simple string-rewriting is very, very powerful, while sounding overly-restrictive on the surface. One can design and build whole new languages by transpiling them into existing languages for compilation (that's how I use my 't2t' and 'tmx' stuff). I consider the shell (/bin/bash, /bin/zsh, etc.) to be my IDE. PLs are just "little tools" that plug into the IDE. I don't have to stick to using one language. I can pick and choose. Transpiling a new language (or nano-DSL, or Diagrammatic Programming Language) into some other language fits neatly into this workflow. The fact that OhmJS is written in JS doesn't mean that you have to use JS. You can map XYZ to Lua (or whatever). I can supply a /lot/ more info, if this interests you.

# Content

## 💬 **Walker Griggs**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/linking-together.html#2025-04-08T19:11:31.847Z)

Meta information diet thread: What are blogs / publications that you read frequently?


## 🎥 [This Game Did Everything. What Happened?](https://www.youtube.com/watch?v=AVaj_3134zU) via [Mariano Guerra](https://twitter.com/warianoguerra)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/linking-together.html#2025-04-13T12:41:49.603Z)

![Youtube Thumbnail](https://img.youtube.com/vi/AVaj_3134zU/hqdefault.jpg)

[This Game Did Everything. What Happened?](https://www.youtube.com/watch?v=AVaj_3134zU)
...
[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/of-ai.html#2025-04-09T16:07:48.767Z)
...
## 📝 [Self-Steering Language Models](https://arxiv.org/abs/2504.07081) via [Jack Rusher](https://twitter.com/jackrusher)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/of-ai.html#2025-04-10T16:48:33.602Z)
...
[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/04/W2/of-ai.html#2025-04-13T13:35:15.652Z)
