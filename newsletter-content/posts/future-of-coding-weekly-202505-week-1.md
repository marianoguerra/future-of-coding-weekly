<!--
.. title: Future of Coding Weekly 2025/05 Week 1
.. slug: future-of-coding-weekly-202505-week-1
.. date: 2025-05-04 22:43:58 UTC+02:00
.. tags: 
.. category: 
.. link: 
.. description: 
...
💡 Elliot's amazing work 🎥 Thinking with sand 🎥 Cellular Automaton Drives a Simulated Vehicle

# Two Minute Week

## 📑 [C++ codes for fitting ellipses, circles, lines](https://people.cas.uab.edu/~mosya/cl/CPPcircle.html) via **Marek Rogalski**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/two-minute-week.html#2025-04-30T16:50:56.027Z)

I'm working on nice UI for working with assembly instruction cards recently. Today I've spent some time fiddling around with [Ivan Reese](http://ivanish.ca/)'s [github.com/ivanreese/knob](https://github.com/ivanreese/knob) trying to use it for switching condition codes in a smooth manner. Condition codes are discrete values, and there are just 16 of them but it feels nice to switch them out in a continuous manner. Still not finished but the results look interesting so sharing them here. ([code](https://github.com/mafik/automat/blob/main/src/knob.cc))



A key component of the gesture logic is fitting a circle to a bunch of points. Turns out it's really hard. I've wasted quite a bit of time before stumbling on Nikaolai Chernov's excellent home page: [people.cas.uab.edu/~mosya/cl/CPPcircle.html](https://people.cas.uab.edu/~mosya/cl/CPPcircle.html) . Strongly recommend bookmarking this one - you never know when you'll have to fit a circle to your data!

## 🦋 [Converter for Observable notebooks to Lopecode aka Jumpgate](https://bsky.app/profile/larkworthy.bsky.social/post/3lo447cw4zk2z) via [Tom Larkworthy](https://webcode.run)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/two-minute-week.html#2025-05-01T10:42:32.484Z)

I've finally built my converter for Observable notebooks to Lopecode aka Jumpgate. Feels good ([blusky post](https://bsky.app/profile/larkworthy.bsky.social/post/3lo447cw4zk2z)). Its 2:45 sorry, but it gives a full project overview.




* Github [repository](https://github.com/tomlarkworthy/lopecode)
* Observable [collection](https://observablehq.com/collection/@tomlarkworthy/lopebook)

🎥 [Jumpgate intro](http://history.futureofcoding.org/history/msg_files/F08/F08QV7HFP5F.mp4)

# Our Work

## 💡 [Elliot's Work](https://mathstodon.xyz/@vez/114422477827339953) via [Kartik Agaram](http://akkartik.name/about)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/share-your-work.html#2025-04-29T19:54:27.227Z)

Not mine, but [this work by Elliot](https://mathstodon.xyz/@vez/114422477827339953) is awesome.
...
## ✍ [Prosetta: Poetic graphical esolang](https://stinkymilo.github.io/Prosetta/Frontend/docs/#/Overview) via [Charlie Roberts](https://www.charlie-roberts.com)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/share-your-work.html#2025-05-01T19:13:44.528Z)

Sharing a fun student capstone project I advised, an Esolang for 2D drawing / animation using free prose:

- [Prosetta Overview](https://stinkymilo.github.io/Prosetta/Frontend/docs/#/Overview)
- [Prosetta Playground](https://stinkymilo.github.io/Prosetta/Frontend/)
...
## 🎥 [FDD - Failure Driven Development](https://youtu.be/0m0fXwFLgTE) via [Paul Tarvydas](https://guitarvydas.github.io/2021/09/23/Manifesto.html)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/share-your-work.html#2025-05-02T02:22:31.924Z)

![Youtube Thumbnail](https://img.youtube.com/vi/0m0fXwFLgTE/hqdefault.jpg)

Ideas for using existing tools to augment program development workflow

## 🐸 [pondiverse.com](https://www.pondiverse.com/) via [Lu Wilson](https://twitter.com/TodePond)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/share-your-work.html#2025-05-02T17:59:30.886Z)

we made a place to share and explore creations from creative tools. you can connect your own tool to it too if u want

[pondiverse.com](https://www.pondiverse.com/)

# Thinking Together

## 💬 **Declan**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-04-29T14:06:43.297Z)
...
## 🗨️ by [Kartik Agaram](http://akkartik.name/about)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-04-30T00:53:36.421Z)

I finally got around to Dave Ackley's latest video report on robust-first computing which [Andreas S](https://twitter.com/curious_reader) shared [💬 #linking-together@2025-04-28](https://history.futureofcoding.org/?fromDate=2025-04-25&toDate=2025-05-01&channel=linking-together&filter=#2025-04-28T15:48:10.195Z), and it prompted me to zoom out and think about the territory of computation and what we know of it so far in the year 2025. Right now I imagine it as a 3D terrain. Along one axis, analogous to a [plan view](https://en.wikipedia.org/wiki/Multiview_orthographic_projection), I see the following coarse  _technical_  approaches to structuring computation, each equally valid:
...
[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-04-30T16:29:03.032Z)
...
## 📝 [Eidetic Systems](https://www.usenix.org/conference/osdi14/technical-sessions/presentation/devecsery) via **Spencer Fleming**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-04-30T23:47:59.162Z)
...
[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-05-02T08:27:09.964Z)
...
## 🎥 [Maggie Appleton Lecture for MIT Media Lab's Thinking With Sand Lunch Lecture Series](https://www.youtube.com/watch?v=08PPuE-Y1sE) via [Andreas S](https://twitter.com/curious_reader)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-05-02T11:52:43.062Z)

![Youtube Thumbnail](https://img.youtube.com/vi/08PPuE-Y1sE/hqdefault.jpg)

Have you seen this? I liked the Cultural perspective of it

## 💬 [Lu Wilson](https://twitter.com/TodePond)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-05-03T07:39:55.677Z)
...
[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/thinking-together.html#2025-05-03T11:54:51.228Z)
...
## 🎥 [Cellular Automaton Drives a Simulated Vehicle](https://www.youtube.com/watch?v=BtjurVN6rz8) via [Andreas S](https://twitter.com/curious_reader)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/linking-together.html#2025-04-28T15:48:10.195Z)

![Youtube Thumbnail](https://img.youtube.com/vi/BtjurVN6rz8/hqdefault.jpg)

I asked again about Robust Computing, and I think they made some progress

## 🎥 [Algot Tutorial](https://vimeo.com/729159376) via **Beni Cherniavsky-Paskin**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/linking-together.html#2025-04-29T12:08:02.524Z)

![Vimeo Thumbnail](https://i.vimeocdn.com/video/1467699185-7f12f75960fc93dce9549b8f586e86b182b5064a8ce1cd0eb5a1028bf3e28902-d_295x166)

[algot.org](https://algot.org/) — a research visual, by-demonstration (aka code while seeing concrete values 🍰), language operating on graphs.  Papers largely closed-access but [preprints here](https://people.inf.ethz.ch/~sverrirt/publications/).

I find it a bit hard to imagine how one uses it from screenshots, and  ~didn't find videos / lectures?~  OK here's [a (silent) demo](https://vimeo.com/729159376)



In some ways similar to [Subsequently](https://www.youtube.com/watch?v=4rLGHBio5UI) in de-ambiguating user intent by "demonstration" not being "say the result" but "pick an action".

## 📝 [The Shapes of Abstraction in Data Structure Diagrams](https://dl.acm.org/doi/10.1145/3706598.3713723) via **Karl Toby Rosenberg**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/linking-together.html#2025-04-29T16:45:24.624Z)

My friend wrote this CHI ‘25 system paper (open access). Very cool

![IMG_5096](http://history.futureofcoding.org/history/msg_files/F08/F08QVKS9R6C.png)



## 📝 [Understanding Marine Scientist Software Tool Use](https://dl.acm.org/doi/10.1145/3706598.3713621) via **Jeffrey Tao**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/linking-together.html#2025-04-30T02:47:35.050Z)
...
## 🎥 [Prof. Judy Fan: Cognitive Tools for Making the Invisible Visible](https://www.youtube.com/watch?v=AF3XJT9YKpM) via [Christopher Shank](https://mobile.twitter.com/chrisshank23)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/linking-together.html#2025-05-01T00:58:25.588Z)

![Youtube Thumbnail](https://img.youtube.com/vi/AF3XJT9YKpM/hqdefault.jpg)
...
## 📝 [Mechanical Computing](https://tennysontbardwell.com/blog/2025/04/30/mechanical-computing/index.html) via [Paul Tarvydas](https://guitarvydas.github.io/2021/09/23/Manifesto.html)

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/linking-together.html#2025-05-01T02:18:29.326Z)
...
## 📝 [ChatGPT - Cutie Mark Crusaders' Origins](https://chatgpt.com/share/6810fec6-5c54-8004-9993-aafb5d038d68) via **William Taysom**

[🧵 conversation](https://history.futureofcoding.org/history/weekly/2025/05/W1/of-ai.html#2025-04-29T16:31:18.168Z)
