...
function getInfoForWeekAndDay(now, dayNumber) {
  const nextDay = findNextWeekDay(now, dayNumber),
    ...
    issueTitle = `Feeling of Computing Weekly ${curYear}/${monthStr} Week ${weekNumber}`,
    newsletterUrl = `https://newsletter.futureofcoding.org/posts/feeling-of-computing-weekly-${curYear}${monthStr}-week-${weekNumber}/`;
