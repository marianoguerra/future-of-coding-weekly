// https://github.com/Khan/perseus/tree/main/packages/simple-markdown MIT
...
var parserFor = function (
  ...
  ruleList.sort(function (typeA, typeB) {
    var ruleA /* : ParserRule */ =
      /** @type {SimpleMarkdown.ParserRule} */ (rules[typeA] /*:: :any */);
    var ruleB /* : ParserRule */ =
      /** @type {SimpleMarkdown.ParserRule} */ (rules[typeB] /*:: :any */);
  ...
  var nestedParse = function (source, /* : string */ state /* : ?State */) {
    ...
    while (source) {
      ...
      var currRule /* : ParserRule */ =
        /** @type {SimpleMarkdown.ParserRule} */ (rules[
          currRuleType
        ] /*:: :any */);

      do {
        var currOrder = currRule.order;
        var prevCaptureStr = state.prevCapture == null
          ? ""
          : state.prevCapture[0];
        ...
        currRule = /*::((*/ /** @type {SimpleMarkdown.ParserRule} */ (rules[
          currRuleType
        ]) /*:: : any) : ParserRule)*/;
      } while (
  ...
  list: {
    ...
    parse: function (capture, parse, state) {
      ...
      var itemContent = items.map(
        function (/** @type {string} */ item, /** @type {number} */ i) {
    ...
    html: function (node, output, state) {
      var listItems = node.items.map(
        function (/** @type {SimpleMarkdown.ASTNode} */ item) {
    ...
    parse: function (capture, parse, state) {
      ...
      if (state._refs && state._refs[def]) {
        ...
        state._refs[def].forEach(
          function (/** @type {SimpleMarkdown.RefNode} */ refNode) {
  ...
  table: {
    ...
    html: function (node, output, state) {
      ...
      var rows = node.cells.map(
        function (/** @type {SimpleMarkdown.ASTNode[]} */ row) {
